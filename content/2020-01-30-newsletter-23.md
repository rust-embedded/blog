...
- [@almindor] released a platform-agnostic [driver for the MAX7219][max7219-driver] segmented display published a [blog post][max7219-blog-post] including a picture of an example setup. 
